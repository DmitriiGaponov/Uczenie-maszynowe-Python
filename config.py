...
# Preferuj pełny dataset lokalnie. Jeśli go nie ma, użyj sample z repo.
...
# Jeśli Twój pipeline tworzy dane przetworzone – zapisuj lokalnie (ignorowane przez git)
PROCESSED_PATH = Path("data/processed/dataset_clean.csv")

# Gdzie zapisujesz wykresy / wyniki
